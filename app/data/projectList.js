const projectList = [
  {
    ...
    role: [
      `<p>전체 프로젝트 기획 참여</p>`,
      `<ul><li><strong>Admin</strong></li><li>신고, 유저, 에세이 페이지의 목록 페이지 및 상세 페이지, 정보 수정 기능 구현</li><li><a href="https://demos.creative-tim.com/material-dashboard-react/?_ga=2.267973773.283166163.1714912945-2094032612.1714912945#/dashboard" target="_blank">오픈소스를 가져와 리팩토링 진행</a></li></ul>`,
      `<ul><li><strong>Web</strong></li><li>약관 페이지(태블릿, 모바일 반응형 적용)</li><li>사이드바</li></ul>`,
    ],
    deploymentLink: [
      `<strong>관리자 페이지</strong>`,
      `<a href="https://linkedout-umber.vercel.app/authentication/sign-in" target="_blank">https://linkedout-umber.vercel.app/authentication/sign-in</a>`,
      `<strong>약관페이지(태블릿, 모바일 반응형 적용)</strong>`,
      `<a href="https://www.linkedoutapp.com/terms" target="_blank">https://www.linkedoutapp.com/terms</a>`,
      `<a href="https://www.linkedoutapp.com/privacy-policy" target="_blank">https://www.linkedoutapp.com/privacy-policy</a>`,
      `<a href="https://www.linkedoutapp.com/location-terms" target="_blank">https://www.linkedoutapp.com/location-terms</a>`,
      `<a href="https://www.linkedoutapp.com/operational-policy" target="_blank">https://www.linkedoutapp.com/operational-policy</a>`,
    ],
  ...
  },
  {
    ...
    deploymentLink: [
      `<a href="https://portpolio-gilt.vercel.app/" target="_blank">https://portpolio-gilt.vercel.app/</a>`,
    ],
    githubLink: "https://github.com/jungyeon-rgb/portfolio",
    relatedLink: ["http://43.200.112.139:8080/swagger-ui/index.html"],
  },
  {
    id: 3,
  ...
  },
  {
    ...
    title: "Basil Farm",
    description: [
      `<strong>🏆 엘리스 IoT 1기 최종 프로젝트 최우수상 수상</strong>`,
    ...
    role: [
      ...
      "SSG를 적용해 빌드 후 변경이 없는 페이지(메인페이지, 로그인, 회원가입) 구현",
      "SSR을 적용하여 디바이스 추가 가능성이 있는 마이페이지를 구현함",
      "Recoil로 로그인 상태 관리",
    ],
    deploymentLink: "https://smart-basil-farm.vercel.app",
