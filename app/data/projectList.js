const projectList = [
  ...
  },
  {
    ...
    role: [
      ...
      "S3와 CloudFront를 사용한 정적 파일의 고속 배포 및 성능 최적화",
      "버전 관리 및 협업 도구로 Git과 GitHub 사용",
      "CI/CD 파이프라인 구축을 통한 자동 배포 설정 (Vercel 사용)",
      "웹 접근성(Accessibility)을 고려하여 모든 사용자가 접근 가능한 웹사이트 제작",
      "SEO(Search Engine Optimization) 최적화를 통한 검색 엔진 가시성 향상",
      "자신의 기술 블로그와 연동하여 최신 프로젝트와 학습 내용을 지속적으로 업데이트",
    ],
