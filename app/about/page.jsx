...
const About = () => {
    ...
    return (
        <section className="font-pretendard">
            ...
            <article className="flex flex-col items-start gap-8 px-4 mt-8 md:flex-row lg:flex-row lg:px-40 md:px-20 md:mt-12 lg:mt-16">
                <section className="flex flex-col w-full text-left md:w-1/5 lg:w-1/5">
                ...
                <section className="flex flex-col w-full ml-12 md:w-2/5 lg:w-2/5">
                    <div>
                        <h1 className="text-xl font-bold underline">CHARACTER</h1>
                        <p>긍정적인, 끈기있는, 도전적인, 유연한 단단함</p>
                    </div>
                    <div className="mt-6">
                        <h1 className="text-xl font-bold underline">INTERESTED IN</h1>
                        <div>Travel, Photography, Music, Fashion</div>
                    </div>
                    <div className="mt-6">
                        <h1 className="text-xl font-bold underline">COMMUNICATION SKILLS</h1>
                        <div>Notion, Figma, Swagger, Trello, Jira</div>
                    </div>
                    <div className="mt-8">
                        <h1 className="mb-2 text-xl font-bold underline">QR Code</h1>
                        <div className="flex">
                            <div className="">
                ...
                <section className="w-full md:w-2/5 lg:w-3/5 h-[300px] md:h-[400px] lg:h-[500px] overflow-y-auto">
                    <div className="flex">
                        <h1 className="mb-4 text-xl font-bold underline">SOFTWARES</h1>
                        <span className="ml-4">(마우스를 올리시면 관련 설명이 표시됩니다.)</span>
                    </div>
                        ...
                        {aboutData.map((software, index) => (
                            ...
                            >
                                <div className="flex items-center justify-between">
                                    <span className="text-lg font-semibold cursor-pointer">{software.title}</span>
