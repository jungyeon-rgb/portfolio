...
const projectList = [
    {
        ...
        technologies: "1. Admin - React, 2. Web - Next.js, Styled-components, Zustand",
        ...
        <div className="relative w-full overflow-hidden">
            <div className="flex" ref={slideRef}>
                {projectList.map((project) => (
                    <div key={project.id} className="flex justify-between items-center flex-shrink-0 w-full h-[600px]">
                        <div className="relative w-full h-full overflow-hidden">
                            <Image src={project.imageSrc} alt={project.title} fill="true" />
                        </div>
